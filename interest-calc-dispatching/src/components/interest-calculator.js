    ...
    <form className="interest-calculator" onSubmit={e => e.preventDefault()}>
      <div className="form-group">
        ...
        <input
          ...
          min="0"
          onChange={event => {
            props.dispatch(setPrincipal(Number(event.target.value)));
          }}
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          step="0.1"
          onChange={event => {
            props.dispatch(setInterest(Number(event.target.value)));
          }}
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          max="100"
          onChange={event => {
            props.dispatch(setYears(Number(event.target.value)));
          }}
        />
      </div>
      <div className="form-group">
